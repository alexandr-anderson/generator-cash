  ...
  return (
    <PublicShell>
      <article className="legal-doc">
        ...
        <p>
          Сюда же пишите, если не пришло письмо подтверждения, сломалась генерация, нужно удалить
          аккаунт или поднять лимит генераций, а ещё — с вопросами про персональные данные и про
          оплату, когда она появится.
        </p>
        <p>
